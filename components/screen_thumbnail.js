...
export default class ScreenThumbnail extends Component {
  htmlContent = imgUrl => `<html><body style="background-size: cover; background-position: center; background-image: url('${imgUrl}')"></body></html>`
  render = () => {
    ...
    return (
      <View style={styles.wrapper}>
        <WebView
          ...
          source={source}
        />
        <TouchableOpacity style={styles.front} onPress={this.props.onPress} />
      </View>
    );
  }
}
